 ...
 */
@JsonPropertyOrder({
  JoinRequest.JSON_PROPERTY_NAME
})
...
public class JoinRequest {
  ...
  public JoinRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this JoinRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, joinRequest.name);
  }
